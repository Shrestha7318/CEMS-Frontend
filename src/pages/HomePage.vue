<template>
  <!-- HERO  -->
  <div id="hero" class="relative overflow-hidden h-[100svh] md:min-h-[92svh] flex items-center
           w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw]">
    <img src="https://images.unsplash.com/photo-1501862700950-18382cd41497?q=80&w=2400&auto=format&fit=crop"
      alt="Coastal waters" class="absolute inset-0 h-full w-full object-cover" />
    ...
    <div class="relative z-10 max-w-4xl px-6 md:px-10 text-left text-white pt-20">
      ...
      <div class="mt-7 flex flex-wrap items-center gap-4">
        <RouterLink to="/dashboard" class="btn-line btn-line-hero">
          Open dashboard
        </RouterLink>
        <RouterLink to="/devices" class="btn-line btn-line-hero">
          Explore devices
        </RouterLink>
      </div>
  ...
  <section class="container mx-auto px-6 lg:px-12 -mt-8 md:-mt-12">
    <div class="rounded-2xl backdrop-blur border border-white/20 dark:border-slate-800
      ...
      <div class="flex items-center gap-3">
        <svg class="w-6 h-6 opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"
  ...
  <div class="container mx-auto px-6 lg:px-12 space-y-16 md:space-y-20 pb-28">
    ...
    <section class="space-y-6 pt-16">
      ...
      <p class="text-slate-700 dark:text-slate-300 max-w-3xl">
        ...
        CEMS integrates low-cost sensors, resilient communications, and a community-first workflow to improve local
        decisions.
      </p>
      ...
      <div class="flex flex-wrap gap-2">
        <span class="inline-flex items-center gap-2 text-sm px-3 py-1.5 rounded-full
          ...
          <!-- shield-check -->
          <svg class="w-4 h-4 opacity-70" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"
            stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 22c6-2 8-5.5 8-10V7l-8-4-8 4v5c0 4.5 2 8 8 10" />
    ...
    <section>
      ...
      <div class="grid md:grid-cols-3 gap-6">
        <!-- Card -->
        <div
          class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 p-5 hover:-translate-y-0.5 transition">
    ...
    <section>
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 mb-3">Pan and zoom the map to explore device locations. Click a
        marker for more details.</p>
      <div class="rounded-[28px] border border-slate-200 dark:border-slate-800
        ...
        <div class="rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden relative">
          <div
            class="absolute top-2 left-1/2 -translate-x-1/2 w-24 h-1.5 rounded-full bg-slate-300/70 dark:bg-slate-700/70">
          </div>
      ...
      <div class="grid md:grid-cols-3 gap-6">
        ...
        <div
          ...
          <div class="flex items-center gap-2">
            <!-- globe -->
            <svg class="w-5 h-5 opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"
              stroke-linecap="round" stroke-linejoin="round">
    ...
    <section>
      ...
      <div class="grid sm:grid-cols-2 gap-6">
        ...
        <div class="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/60 p-6">
          ...
          <ul class="text-sm text-slate-600 dark:text-slate-300 grid grid-cols-2 gap-x-4 gap-y-1">
            <li v-for="it in ['Temperature', 'Humidity', 'Noise', 'Illumination']" :key="it"
    ...
    <!-- CTA -->
    <section
      class="rounded-2xl border border-slate-200 dark:border-slate-800 p-6 md:p-8
      ...
      <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        <div class="flex gap-3">
          <RouterLink to="/dashboard" class="btn-line btn-line-cta">
            Open Dashboard
          </RouterLink>
          <RouterLink to="/devices" class="btn-line btn-line-cta">
            View Devices
          </RouterLink>
        </div>
      </div>
...
<style scoped>
/* Base underline button */
.btn-line {
  @apply relative inline-block px-5 py-2 font-medium;
